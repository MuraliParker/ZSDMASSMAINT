		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsdmassmaintparkerzsdmassmaint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsdmassmaintparkerzsdmassmaint-display": {
								"semanticObject": "comsdmassmaintparkerzsdmassmaint",
								"action": "display",
								"description": "Mass Maintenance of sales order creation and change",
								"title": "Mass Maintenance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sd.massmaint.parker.zsdmassmaint",
									"url": sap.ui.require.toUrl("com/sd/massmaint/parker/zsdmassmaint")
								}
							}
						}
					}
